...
class ElementPaillasseRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'category_element_result_id.required' => 'La catégorie de l\'élément est requise.',
            'category_element_result_id.exists' => 'La catégorie de l\'élément n\'existe pas.',
