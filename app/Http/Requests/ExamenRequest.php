...
class ExamenRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'elements.*.category_element_result_id.required' => __("La catégorie de l'élément de résultat est requise."),
            'elements.*.category_element_result_id.exists' => __("La catégorie de l'élément de résultat n'existe pas."),
