...
return new class extends Migration
{
    ...
    {
        Schema::create('ops_tbl_enquetes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('categories_enquetes_id')->nullable()->constrained('configtbl_categories_enquetes')->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('ops_tbl_enquetes');
    }
};
