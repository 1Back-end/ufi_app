...
return new class extends Migration
{
    ...
    {
        Schema::create('ops_tbl_diagnostic', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('type_diagnostic_id')->nullable()->constrained('configtbl_type_diagnostic')->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('ops_tbl_diagnostic');
    }
};
